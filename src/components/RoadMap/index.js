      ...
      <RoadMapContainer>
        <ContentWrapper>
          ...
          <BoxWrapper>
            ...
            <RightNumberWrapper>
              <span>2</span>
              <PointBox id='d2' className='d2'><div className='d2-1' /></PointBox>
            </RightNumberWrapper>
          </BoxWrapper>
          <BoxWrapper isLeft>
            <LeftNumberWrapper>
              <PointBox id='d3' className='d3'><div className='d3-1' /></PointBox>
              <span>3</span>
            </LeftNumberWrapper>
            <div className='gradient-box'>
              <GradientCard>
          ...
          <BoxWrapper>
            ...
            <RightNumberWrapper>
              <span>4</span>
              <PointBox id='d4' className='d4'><div className='d4-1' /></PointBox>
            </RightNumberWrapper>
          </BoxWrapper>
          <BoxWrapper isLeft>
            <LeftNumberWrapper>
              <PointBox id='d5' className='d5'><div className='d5-1' /></PointBox>
              <span>5</span>
            </LeftNumberWrapper>
            <div className='gradient-box'>
              <GradientCard>
          ...
          <BoxWrapper>
            ...
            <RightNumberWrapper>
              <span>6</span>
              <PointBox id='d6' className='d6'><div /></PointBox>
            </RightNumberWrapper>
          </BoxWrapper>
        </ContentWrapper>
        <BackgroundListWrapper>
